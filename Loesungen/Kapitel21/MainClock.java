 ...
 * 
 * This application displays a digital clock on the screen. The application is
 * started by providing three program arguments indicating the initial hours,
 * minutes and seconds.
 * 
 * Program arguments 1) HH - hour (a value from 00 to 23) 2) MM - minute (a
 * value from 00 to 59) 3) SS - second (a value from 00 to 59)
 * 
...
public class MainClock {
    ...
    public static void main(String[] args) {
        ...
        ClockView view = new ClockView(hoursCounter, minsCounter, secsCounter);
