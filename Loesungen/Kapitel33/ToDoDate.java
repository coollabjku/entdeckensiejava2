...
public class ToDoDate {
	...
	public ToDoDate(String dateString) {
		...
		try {
			...
			sdf.setLenient(false); // strikte Überprüfung aktivieren
			sdf.parse(dateString);

			// should use the parsed date to get these values but as the old date getters
			// have been deprecated this is most likely a shorter solution
			...
			throw new ToDoDateException(dateString + "is not a valid date.");
		}
	}
