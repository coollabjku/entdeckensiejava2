...
public class MainCountDownAlarmClock {
    ...
    public static void main(String[] args) {
        ...
        // ChainedCountDownCounter hoursCounter = new ChainedCountDownCounter(h, 24,
        // null);
        // ChainedCountDownCounter minsCounter = new ChainedCountDownCounter(m, 60,
        // hoursCounter);
        // ChainedCountDownCounter secsCounter = new ChainedCountDownCounter(s, 60,
        // minsCounter);

        // CountDownAlarmClockView view;
